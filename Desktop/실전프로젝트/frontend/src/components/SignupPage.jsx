  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <input
          style={{ ...styles.input, border: focused === "name" ? "1.5px solid #E86F00" : "1px solid #e0e0e0" }}
          type="text"
          placeholder="이름"
        ...
        />
        <input
          style={{ ...styles.input, border: focused === "pw2" ? "1.5px solid #E86F00" : "1px solid #e0e0e0" }}
          type="password"
          placeholder="비밀번호 확인"
...
const styles = {
  page: { minHeight: "calc(100vh - 72px)", display: "flex", alignItems: "center", justifyContent: "center", background: "#f5f5f5" },
  ...
  input: { width: "100%", padding: "11px 14px", fontSize: 14, border: "none", borderRadius: 10, marginBottom: 10, boxSizing: "border-box", fontFamily: "inherit", outline: "none" },
